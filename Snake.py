...
class SNAKE:
    def __init__(self):
        ...
        # All the Graphics for the snake
        ...
        self.body_vertical = pygame.image.load(
            'body_vertical.png').convert_alpha()
        self.body_horizontal = pygame.image.load(
            'body_horizontal.png').convert_alpha()
        ...
        # Sound for the Snake
        self.crunch_sound = pygame.mixer.Sound('crunch_sound.wav')
...
class MAIN:
    ...
    def check_fail(self):
        if not 0 <= self.snake.body[0].x < cell_number or not 0 <= self.snake.body[0].y < cell_number:
            self.game_over()  # Check if snail is outside the screen
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(
            orange_rect.left - 5, orange_rect.top - 5, orange_rect.width + score_rect.width + 20, orange_rect.height + 10)
